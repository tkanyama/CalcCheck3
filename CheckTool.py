...
class CheckTool():
    ...
    def PageCheck2(self,filename, outdir, limit ,kind, version, psn, PageNumber,ProcessN):
        global flag1, fname, dir1, dir2, dir3, dir4, dir5, folderName, paraFileName
        global ErrorFlag, ErrorMessage
...
class multicheck:
    ...
    def PageCheck2(self,fname,outdir,psn,PageNumber,ProcessN):
        CT = CheckTool()
        CT.PageCheck2(fname,outdir,self.limit,self.kind,self.version,psn,PageNumber,ProcessN)
...
#       分割された計算書の並列処理
        ...
        if 並列化:
            ...
            for i in range(n-1):
                ...
                P = Process(target=self.PageCheck2, args=([fname, self.dir2 , i, PageNumber, ProcessN]))
                Plist.append(P)
            #next
